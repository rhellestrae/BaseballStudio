...
{
	public partial class NLCentral : ContentPage
	{
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a New York Mets button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Washington Nationals button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Miami Marlins button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is an Atlanta Braves button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Philadelphia Phillies button", "OK");  
		}  
