...
{
	public partial class EasternAL : ContentPage
	{
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Kansas City Royals button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Minnesota Twins button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Cleveland Indians button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Chicago White Sox button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Detroit Tigers button", "OK");  
		}  
