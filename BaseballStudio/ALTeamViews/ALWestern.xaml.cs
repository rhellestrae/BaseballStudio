...
{
	public partial class ALWestern : ContentPage
	{
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Texas Rangers button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Houston Astros button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is an LA Angels button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is a Seattle Mariners button", "OK");  
		}  
		...
		{  
			// handle the tap  
			DisplayAlert("Alert", "This is an Oakland Athletics button", "OK");  
		}  
